...
for(type in types) {
  ...
  comms <- lapply(conds, function(cond) {
    comm_info <- fread(paste0("../regulaciontrans-data/", type, "/", type, "-", cond, 
  ...
  png(paste0("../regulaciontrans-data/", type, "/", "figures/comm-size-boxplot-min-network.png"), width = 750, height = 750)
  print(p)
  dev.off()  
  ...
  png(paste0("../regulaciontrans-data/", type, "/", "figures/comm-size-histogram-min-network.png"), width = 1000, height = 500)
  print(p)
  dev.off()  
  ...
  png(paste0("../regulaciontrans-data/", type, "/", "figures/comm-order-boxplot-min-network.png"), width = 750, height = 750)
  print(p)
  dev.off()  
  ...
  png(paste0("../regulaciontrans-data/", type, "/", "figures/comm-order-histogram-min-network.png"), width = 1000, height = 500)
  print(p)
  dev.off()  
  ...
  png(paste0("../regulaciontrans-data/", type, "/", "figures/comm-density-boxplot-min-network.png"), width = 750, height = 750)
  print(p)
  dev.off()  
  ...
  png(paste0("../regulaciontrans-data/", type, "/", "figures/comm-density-histogram-min-network.png"), width = 1000, height = 500)
  print(p)
  dev.off()  
}
